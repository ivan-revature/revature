...
@WebServlet(description = "Updates employee record on DB", urlPatterns = { "/UpdateEmployee" })
public class UpdateEmployee extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if( updateEmployee(empl_id) ) {
				out.println("Update was sucessful.");
			} else {
				out.println("Update was unsuccessful.");
			}
			out.flush();
			out.close();
		} catch (Exception e) {
	...
	private boolean updateEmployee( int empID )
